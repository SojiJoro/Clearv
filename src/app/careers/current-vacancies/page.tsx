  ...
  return (
    <div className="container my-5">
      ...
      <p>
        ...
        <strong> passionate, dedicated individuals</strong> who want to make a positive 
        impact in their communities. Whether you are a <strong>care worker, support staff, 
        or specialist therapist</strong>, we have a place for you.
      </p>
      ...
      <p className="text-center mt-4">
        <strong>
          Find out more about our latest vacancies and start your journey in care today.
        </strong>
      </p>
    </div>
  );
